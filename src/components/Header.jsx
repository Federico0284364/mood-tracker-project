...
export default function Header() {
	return (
		<header className="w-full flex items-center justify-between bg-transparent h-16">
          ...
          <div className="rounded-full bg-white w-[20%] aspect-square absolute top-3 left-1.5 "/>
          <div className="rounded-full bg-white w-[20%] aspect-square absolute top-3 right-1.5 "/>
        </div>
